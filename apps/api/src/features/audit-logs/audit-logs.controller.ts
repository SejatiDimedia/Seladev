...
export class AuditLogsController {
  ...
  listCrossWorkspaceHistory = asyncWrapper(async (req: Request, res: Response): Promise<void> => {
    const user = (req as any).user;
    ...
    const { logs, hasNext, nextCursor } = await this.auditLogsService.listCrossWorkspaceHistory(
      user,
      limit,
      cursor,
      filters
